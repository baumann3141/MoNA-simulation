...
echo -n "" > /projects/mona-sim/baumann/n2_geant/detector_config_temp
echo "!target position (X Y Z in cm)" >> /projects/mona-sim/baumann/n2_geant/detector_config_temp
echo "0. 0. 1.5" >> /projects/mona-sim/baumann/n2_geant/detector_config_temp
echo "!MoNA" >> /projects/mona-sim/baumann/n2_geant/detector_config_temp

#Build MoNA
for WALL in {A..I}
do
  
   echo "$MoNA_POSITION_VECTOR $NUMBAR $MoNA_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/baumann/n2_geant/detector_config_temp
...
do
   ...
   echo "$LISA1_POSITION_VECTOR $NUMBAR $LISA1_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/baumann/n2_geant/detector_config_temp
...
do
   ...
   echo "$LISA2_POSITION_VECTOR $NUMBAR $LISA2_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/baumann/n2_geant/detector_config_temp
