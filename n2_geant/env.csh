...
#
#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 != X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 ) then
    setenv G4INSTALL "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/src/geant4"
    echo "On this machine the G4INSTALL=$G4INSTALL"
else
    setenv G4INSTALL "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01"
    echo "On this machine the G4INSTALL=$G4INSTALL"
endif
...
if ( Xy != Xn ) then
    if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 != X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 ) then
        setenv G4INCLUDE "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/include/geant4"
    else
        setenv G4INCLUDE "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/include"
    endif
...
#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/lib != X ) then
    if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 != X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 ) then
        setenv G4LIB "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/lib/geant4"
    else
        setenv G4LIB "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/lib"
    endif
...
#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/PhotonEvaporation2.0 != X ) then
    setenv G4LEVELGAMMADATA "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/PhotonEvaporation2.0"
    echo "On this machine the G4LEVELGAMMADATA=$G4LEVELGAMMADATA"
endif

#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RadioactiveDecay3.2 != X ) then
    setenv G4RADIOACTIVEDATA "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RadioactiveDecay3.2"
    echo "On this machine the G4RADIOACTIVEDATA=$G4RADIOACTIVEDATA"
endif

#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4EMLOW6.9 != X ) then
    setenv G4LEDATA "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4EMLOW6.9"
    echo "On this machine the G4LEDATA=$G4LEDATA"
endif

#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4NDL3.13 != X ) then
    setenv G4NEUTRONHPDATA "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4NDL3.13"
    echo "On this machine the G4NEUTRONHPDATA=$G4NEUTRONHPDATA"
endif

#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4ABLA3.0 != X ) then
    setenv G4ABLADATA "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4ABLA3.0"
    echo "On this machine the G4ABLADATA=$G4ABLADATA"
endif

#+
if ( X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RealSurface1.0 != X ) then
    setenv G4REALSURFACEDATA "/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RealSurface1.0"
...
# g4clhep.U
#
if ( X/soft/x86_64/lucid/CLHEP/2.0.4.6 != X ) then
    setenv CLHEP_BASE_DIR "/soft/x86_64/lucid/CLHEP/2.0.4.6"
    echo "On this machine the CLHEP_BASE_DIR=$CLHEP_BASE_DIR"
endif

#+
if ( X/soft/x86_64/lucid/CLHEP/2.0.4.6/include != X ) then
    setenv CLHEP_INCLUDE_DIR "/soft/x86_64/lucid/CLHEP/2.0.4.6/include"
    echo "On this machine the CLHEP_INCLUDE_DIR=$CLHEP_INCLUDE_DIR"
endif

#+
if ( X/soft/x86_64/lucid/CLHEP/2.0.4.6/lib != X ) then
    setenv CLHEP_LIB_DIR "/soft/x86_64/lucid/CLHEP/2.0.4.6/lib"
...
#+
if ( "Xn" == "Xy" || "Xn" == "Xy" )  then
    setenv QTFLAGS "-I/usr/include/qt3"
    setenv QTLIBS "-L/usr/lib -lqt-mt"
    setenv QTMOC "/usr/bin/moc-qt3"
...
if ( "Xn" == "Xy" || "Xn" == "Xy" )  then
    ...
    setenv GLQTLIBS "-L/usr/lib -lqt-mt "
    echo "On this machine the QTFLAGS=$QTFLAGS"
