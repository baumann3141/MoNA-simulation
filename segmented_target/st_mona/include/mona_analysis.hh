...
private:  // these go to the tree
  ...
  double EDecayTotalG3and4;
  double EDecayG_3neutron, EDecayTotalG12and3, EDecay4body;
  ...
  double Ysys_Ex_Et2;
  // no res versions
  double Tsys_CosTheta1_noRes;
  double Tsys_CosTheta2_noRes;
  double Ysys_CosTheta1_noRes;
  double Ysys_CosTheta2_noRes;
  double Tsys_Ex_Et1_noRes;
  double Tsys_Ex_Et2_noRes;
  double Ysys_Ex_Et1_noRes;
  double Ysys_Ex_Et2_noRes;
