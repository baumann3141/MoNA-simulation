...
MoNA_X0=-2.374
MoNA_X=`echo "$1*s($MoNA_ANGLE)+$MoNA_X0" | bc -l`
MoNA_dX=`echo "$dRm*s($MoNA_ANGLE)" | bc -l`
...
MoNA_dZ=`echo "$dRm*c($MoNA_ANGLE)" | bc -l`


#decompose GAP M1, HL 5/14/15
GAPM1_X=`echo "$GAP_M1*s($MoNA_ANGLE)" | bc -l`
GAPM1_Z=`echo "$GAP_M1*c($MoNA_ANGLE)" | bc -l`

#decompose GAP M2, HL 5/14/15
...
LISA1_X0=-0.456
LISA1_X=`echo "$3*s($LISA1_ANGLE)+$LISA1_X0" | bc -l`
LISA1_dX=`echo "$dRl*s($LISA1_ANGLE)" | bc -l`
...
LISA1_dZ=`echo "$dRl*c($LISA1_ANGLE)" | bc -l`
...
LISA2_X0=-1.408
LISA2_X=`echo "$5*s($LISA2_ANGLE)+$LISA2_X0" | bc -l`
LISA2_dX=`echo "$dRl*s($LISA2_ANGLE)" | bc -l`
...
LISA2_dZ=`echo "$dRl*c($LISA2_ANGLE)" | bc -l`
