...
echo -n "" > /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}
echo "!target position (X Y Z in cm)" >> /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}
echo "0. 0. 1.5" >> /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}
echo "!MoNA" >> /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}

#Build MoNA group1 (3 members)
for WALL in {A..C}
do
  
   echo "$MoNA_POSITION_VECTOR $NUMBAR $MoNA_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}
...
do
   ...
   echo "$LISA1_POSITION_VECTOR $NUMBAR $LISA1_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}
...
do
   ...
   echo "$LISA2_POSITION_VECTOR $NUMBAR $LISA2_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/baumann/n2_geant/detector_config_3g_${uniqueID}
