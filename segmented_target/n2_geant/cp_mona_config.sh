...
echo -n "" > path to config file
echo "!target position (X Y Z in cm)" >> path to config file
echo "0. 0. 1.5" >> path to config file
echo "!MoNA" >> path to config file

#Build MoNA
for WALL in {A..I}
do
  
   echo "$MoNA_POSITION_VECTOR $NUMBAR $MoNA_FACING_VECTOR $BAR $WALL" >> path to config file
...
do
   ...
   echo "$LISA1_POSITION_VECTOR $NUMBAR $LISA1_FACING_VECTOR $BAR $WALL" >> path to config file
...
do
   ...
   echo "$LISA2_POSITION_VECTOR $NUMBAR $LISA2_FACING_VECTOR $BAR $WALL" >> path to config file
