...
int main(int argc, char *argv[])
{
	  ...
	  Double_t b1p0x,b1p0tx,b1p0y,b1p0ty,b1p0Ekin,
		   ...
		   b9p4t,b9p4x,b9p4y,b9p4z,b9p4Ekin;
            ...
            string bn_old[] = {"b1p0x", "b1p0tx", "b1p0y", "b1p0ty", "b1p0Ekin",
                "b2p0x", "b2p0tx", "b2p0y", "b2p0ty", "b2p0t", "b2p0z", "b2p0TP", "b2p0dE", "b2p0Ekin",
		"b2p0_pz","b2p0R_exen", "b2p0R_exen2", "b2p0R_exen3", "b2p0R_exen4", "b2p0R_ph", "b2p0R_ph2", "b2p0R_ph3", "b2p0R_ph4", "b2p0R_th", "b2p0R_th2", "b2p0R_th3", "b2p0R_th4",
	...
	tOut->Branch(first_Edep.c_str(),ps_Edep[l],second_Edep.c_str());
	  ...
	  Double_t b1p0x,b1p0tx,b1p0y,b1p0ty,b1p0Ekin,
		   ...
		   b9p3t,b9p3x,b9p3y,b9p3z,b9p3Ekin;
            ...
            string bn_old[] = {"b1p0x", "b1p0tx", "b1p0y", "b1p0ty", "b1p0Ekin",
                "b2p0x", "b2p0tx", "b2p0y", "b2p0ty", "b2p0t", "b2p0z", "b2p0TP", "b2p0dE", "b2p0Ekin",
		"b2p0_pz","b2p0R_exen", "b2p0R_exen2", "b2p0R_exen3", "b2p0R_ph", "b2p0R_ph2", "b2p0R_ph3", "b2p0R_th", "b2p0R_th2", "b2p0R_th3",
                "b4p0x", "b4p0tx", "b4p0y", "b4p0ty", "b4p0t", "b4p0Ekin",
                "b6p0x", "b6p0tx", "b6p0y", "b6p0ty", "b6p0Ekin",
                "b9p1t", "b9p1x", "b9p1y", "b9p1z", "b9p1Ekin",
                "b9p2t", "b9p2x", "b9p2y", "b9p2z", "b9p2Ekin",
	...
	tOut->Branch(first_Edep.c_str(),ps_Edep[l],second_Edep.c_str());
        ...
        {	cout << "2 NEUTRON!" << endl;
            // Now we find the relevant branches to look at
	    // Added b4p0path and b6p0path THR 24 Jan 2017
	    // Added b2p1Ekin and b2p2Ekin THR 8  Feb 2017
	    // Added neutron 1 and 2 b2tx and b2ty (added 4 parameters) THR 5 July 2017
	  //Double_t b1p0x,b1p0tx,b1p0y,b1p0ty,b1p0Ekin,b2p0x,b2p0tx,b2p0y,b2p0ty,b2p0t,b2p0z,b2p0TP,b2p0dE,b2p0Ekin,b2p0R_pz,b2p0R_exen,b2p0R_exen2,b2p0R_ph,b2p0R_ph2,b2p0R_th,b2p0R_th2,b2p1Ekin,b2p1tx,b2p1ty,b2p2Ekin,b2p2tx,b2p2ty,b4p0x,b4p0tx,b4p0y,b4p0ty,b4p0t,b4p0Ekin,b4p0path,b6p0Ekin,b6p0path,b6p0x,b6p0y,b6p0tx,b6p0ty,b9p1t,b9p1x,b9p1y,b9p1z,b9p1Ekin,b9p2t,b9p2x,b9p2y,b9p2z,b9p2Ekin;
	  Double_t b1p0x,b1p0tx,b1p0y,b1p0ty,b1p0Ekin,
	  b2p0x,b2p0tx,b2p0y,b2p0ty,b2p0z,b2p0dE,b2p0Ekin,
	  b3p0x,b3p0tx,b3p0y,b3p0ty,b3p0TP,b3p0dE,b3p0Ekin,b3p1Ekin,b3p1tx,b3p1ty,b3p2Ekin,b3p2tx,b3p2ty,
	  b4p0x,b4p0tx,b4p0y,b4p0ty,b4p0z,b4p0dE,b4p0Ekin,
	  b5p0x,b5p0tx,b5p0y,b5p0ty,b5p0TP,b5p0dE,b5p0Ekin,b5p1Ekin,b5p1tx,b5p1ty,b5p2Ekin,b5p2tx,b5p2ty,
	  b6p0x,b6p0tx,b6p0y,b6p0ty,b6p0z,b6p0dE,b6p0Ekin,
	  b7p0x,b7p0tx,b7p0y,b7p0ty,b7p0TP,b7p0dE,b7p0Ekin,b7p1Ekin,b7p1tx,b7p1ty,b7p2Ekin,b7p2tx,b7p2ty,
	  ...
	  b12p0x,b12p0tx,b12p0y,b12p0ty,b12p0Ekin,b12p0path;
	    ...
	    // Added neutron 1 and 2 b2tx and b2ty (added 4 parameters) THR 5 July 2017
            string bn_old[] = {"b1p0x", "b1p0tx", "b1p0y", "b1p0ty", "b1p0Ekin",
                "b2p0x", "b2p0tx", "b2p0y", "b2p0ty", "b2p0z", "b2p0dE", "b2p0Ekin",
                "b3p0x", "b3p0tx", "b3p0y", "b3p0ty", "b3p0TP", "b3p0dE", "b3p0Ekin",
		"b3p1Ekin","b3p1tx","b3p1ty","b3p2Ekin","b3p2tx","b3p2ty",
                "b4p0x", "b4p0tx", "b4p0y", "b4p0ty", "b4p0z", "b4p0dE", "b4p0Ekin",
                "b5p0x", "b5p0tx", "b5p0y", "b5p0ty", "b5p0TP", "b5p0dE", "b5p0Ekin",
		"b5p1Ekin","b5p1tx","b5p1ty","b5p2Ekin","b5p2tx","b5p2ty",
                "b6p0x", "b6p0tx", "b6p0y", "b6p0ty", "b6p0z", "b6p0dE", "b6p0Ekin",
                "b7p0x", "b7p0tx", "b7p0y", "b7p0ty", "b7p0TP", "b7p0dE", "b7p0Ekin",
		"b7p1Ekin","b7p1tx","b7p1ty","b7p2Ekin","b7p2tx","b7p2ty",
                "b8p0x", "b8p0tx", "b8p0y", "b8p0ty", "b8p0z", "b8p0dE", "b8p0Ekin",
		"b10p0x","b10p0tx","b10p0y","b10p0ty","b10p0Ekin","b10p0path",
		"b12p0x","b12p0tx","b12p0y","b12p0ty","b12p0Ekin","b12p0path"
                };
	    ...
	    TString n2name = dirdata+"/neutron2"+uniqueID+".root";//neutron2
            ...
            // We want to preserve the original st-mona parameters
	    // ... and add b4p0path and b6p0path THR 24 Jan 2017
	    // ... and add b2p1Ekin and b2p2Ekin THR 8  Feb 2017
	    // Added neutron 1 and 2 b2tx and b2ty (added 4 parameters) THR 5 July 2017
            TBranch *obb1p0x = tOut->Branch("b1p0x",&b1p0x,"b1p0x/D");
            TBranch *obb1p0tx = tOut->Branch("b1p0tx",&b1p0tx,"b1p0tx/D");
            TBranch *obb1p0y = tOut->Branch("b1p0y",&b1p0y,"b1p0y/D");
...
//            TBranch *obb2p0TP = tOut->Branch("b2p0TP",&b2p0TP,"b2p0TP/D");
	    ...
	    /*
            ...
            TBranch *obb2p1Ekin = tOut->Branch("b2p1Ekin",&b2p1Ekin,"b2p1Ekin/D");
            TBranch *obb2p1tx = tOut->Branch("b2p1tx",&b2p1tx,"b2p1tx/D");
            TBranch *obb2p1ty = tOut->Branch("b2p1ty",&b2p1ty,"b2p1ty/D");
            TBranch *obb2p2Ekin = tOut->Branch("b2p2Ekin",&b2p2Ekin,"b2p2Ekin/D");
            TBranch *obb2p2tx = tOut->Branch("b2p2tx",&b2p2tx,"b2p2tx/D");
            TBranch *obb2p2ty = tOut->Branch("b2p2ty",&b2p2ty,"b2p2ty/D");
*/
...
//            TBranch *obb3p0t = tOut->Branch("b3p0t",&b3p0t,"b3p0t/D");
//            TBranch *obb3p0z = tOut->Branch("b3p0z",&b3p0z,"b3p0z/D");
            ...
            TBranch *obb3gp1Ekin = tOut->Branch("b3p1Ekin",&b3p1Ekin,"b3p1Ekin/D");
            TBranch *obb3gp1tx = tOut->Branch("b3p1tx",&b3p1tx,"b3p1tx/D");
            TBranch *obb3gp1ty = tOut->Branch("b3p1ty",&b3p1ty,"b3p1ty/D");
            TBranch *obb3gp2Ekin = tOut->Branch("b3p2Ekin",&b3p2Ekin,"b3p2Ekin/D");
            TBranch *obb3gp2tx = tOut->Branch("b3p2tx",&b3p2tx,"b3p2tx/D");
            TBranch *obb3gp2ty = tOut->Branch("b3p2ty",&b3p2ty,"b3p2ty/D");
...
//            TBranch *obb5p0t = tOut->Branch("b5p0t",&b5p0t,"b5p0t/D");
//            TBranch *obb5p0z = tOut->Branch("b5p0z",&b5p0z,"b5p0z/D");
            ...
            TBranch *obb5gp1Ekin = tOut->Branch("b5p1Ekin",&b5p1Ekin,"b5p1Ekin/D");
            TBranch *obb5gp1tx = tOut->Branch("b5p1tx",&b5p1tx,"b5p1tx/D");
            TBranch *obb5gp1ty = tOut->Branch("b5p1ty",&b5p1ty,"b5p1ty/D");
            TBranch *obb5gp2Ekin = tOut->Branch("b5p2Ekin",&b5p2Ekin,"b5p2Ekin/D");
            TBranch *obb5gp2tx = tOut->Branch("b5p2tx",&b5p2tx,"b5p2tx/D");
            TBranch *obb5gp2ty = tOut->Branch("b5p2ty",&b5p2ty,"b5p2ty/D");
...
//            TBranch *obb7p0t = tOut->Branch("b7p0t",&b7p0t,"b7p0t/D");
//            TBranch *obb7p0z = tOut->Branch("b7p0z",&b7p0z,"b7p0z/D");
            ...
            TBranch *obb7gp1Ekin = tOut->Branch("b7p1Ekin",&b7p1Ekin,"b7p1Ekin/D");
            TBranch *obb7gp1tx = tOut->Branch("b7p1tx",&b7p1tx,"b7p1tx/D");
            TBranch *obb7gp1ty = tOut->Branch("b7p1ty",&b7p1ty,"b7p1ty/D");
            TBranch *obb7gp2Ekin = tOut->Branch("b7p2Ekin",&b7p2Ekin,"b7p2Ekin/D");
            TBranch *obb7gp2tx = tOut->Branch("b7p2tx",&b7p2tx,"b7p2tx/D");
            TBranch *obb7gp2ty = tOut->Branch("b7p2ty",&b7p2ty,"b7p2ty/D");
            ...
            TBranch *obb10p0path = tOut->Branch("b10p0path",&b10p0path,"b10p0path/D");
            ...
            TBranch *obb12p0path = tOut->Branch("b12p0path",&b12p0path,"b12p0path/D");
