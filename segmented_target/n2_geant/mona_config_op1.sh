...
#decompose GAP_L
GAPL_X=`echo "$GAP_L*s($MoNA_ANGLE)" | bc -l`
GAPL_Z=`echo "$GAP_L*c($MoNA_ANGLE)" | bc -l`
...
#Add GAP
   LISA1_X=`echo "$LISA1_X+$GAPL_X" |bc -l`
   LISA1_Z=`echo "$LISA1_Z+$GAPL_Z" |bc -l`
   LISA1_POSITION_VECTOR="$LISA1_X $LISA1_Y $LISA1_Z"
...
#Add GAP
   LISA2_X=`echo "$LISA2_X+$GAPL_X" |bc -l`
   LISA2_Z=`echo "$LISA2_Z+$GAPL_Z" |bc -l`
   LISA2_POSITION_VECTOR="$LISA2_X $LISA2_Y $LISA2_Z"
