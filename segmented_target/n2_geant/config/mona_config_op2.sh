...
echo -n "" > /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}
echo "!target position (X Y Z in cm)" >> /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}
echo "0. 0. 1.5" >> /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}
echo "!MoNA" >> /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}

#Build MoNA group1 (2 members)
for WALL in {A..B}
do
  
   echo "$MoNA_POSITION_VECTOR $NUMBAR $MoNA_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}
...
do
   ...
   echo "$LISA1_POSITION_VECTOR $NUMBAR $LISA1_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}
...
#Add GAP
   LISA1_X=`echo "$LISA1_X+$GAP_X" |bc -l`
   LISA1_Z=`echo "$LISA1_Z+$GAP_Z" |bc -l`
   LISA1_POSITION_VECTOR="$LISA1_X $LISA1_Y $LISA1_Z"
...
do
   ...
   echo "$LISA2_POSITION_VECTOR $NUMBAR $LISA2_FACING_VECTOR $BAR $WALL" >> /projects/mona-sim/han/n2_geant/detector_config_${uniqueID}
...
#Add GAP
   LISA2_X=`echo "$LISA2_X+$GAP_X" |bc -l`
   LISA2_Z=`echo "$LISA2_Z+$GAP_Z" |bc -l`
   LISA2_POSITION_VECTOR="$LISA2_X $LISA2_Y $LISA2_Z"
