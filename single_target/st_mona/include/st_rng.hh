...
public:
  ...
  virtual double getCentroid() {return 0;} //used to get centroid of certain distributions for proper rotation
...
public:
  ...
  double getCentroid()	     { return fCentroid;} /// get centroid //ANK: 6-2-2016 from JKS
...
public:
  ...
  /// destructor
  ~StRNGGaussGSL() {}
  double getCentroid()	     { return fCentroid;} /// get centroid
...
//ANK: 6-2-2016 from JKS for multiple component beam distribution
//-----##########################################################-----//
class StRNGExpPowerGSL : public StRNG {
public:
  StRNGExpPowerGSL(StGSLrng* rr, double a, double b, double c);
  double getCentroid()	     { return fC;} /// get centroid
