...
//   Double_t SetThickness(Double_t thick) {fThickness = thick * fMaterialFactor;}
   void SetThickness(Double_t thick) {fThickness = thick * fMaterialFactor;}
  ...
  enum EMaterials {
     ...
     SrimMaterialDeuterium 		=  14,
     SrimMaterialKapton	                =  15,
     SrimNumberOfMaterials              =  16, //numb material (largest indx+1)
     SrimMaxNumberOfEnergies            = 200	//upper_limit
     };

private:

   Double_t fStopping[92][SrimMaxNumberOfEnergies][7];
