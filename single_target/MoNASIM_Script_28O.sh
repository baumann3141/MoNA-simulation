...
#phase space decay
#arguments="-exp 12004_dp -geant -reac 5body_decay -e asymbw 1.436 0.500 0 0 -n 100000 -strag 1 -be 80.0 -dT 400 -nn 0 -np 2" #"ground" state #-n number of events

#sequential through 26O
arguments="-exp 12004_dp -geant -reac 5body_seq -e1 asymbw 4.000 0.500 2 0  -e3 5body_Constrained 0.150 0.005 2 0 -n 200 -strag 1 -be 80.0 -dT 400 -nn 0 -np 2" #"ground" state #-n number of events

#sequential through 26O di-neutron
#arguments="-exp 12004_dp -geant -reac 5body_seq -e1 asymbw 1.436 0.200 0 0  -e3 5body_Grigorenko 0.150 0.05 -18.7 -n 100000 -strag 1 -be 80.0 -dT 400 -nn 0 -np 2" #"ground" state #-n number of events
...
#UniqueID="_Jones"
#UniqueID="_Calem"
UniqueID="_4000_seq_200EventsTEST"
#UniqueID="_20_target"
