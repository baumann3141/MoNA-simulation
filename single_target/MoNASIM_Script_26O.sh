...
#phase space
arguments="-geant -reac 3body_decay -e asymbw 0.150 0.005 2 0 -n 2000 -strag 1 -be 80.0 -nn 2 -np 2" #"ground" state #-n number of events
...
UniqueID="_E150_W05_B80_T1205_Z800_2000Events"
