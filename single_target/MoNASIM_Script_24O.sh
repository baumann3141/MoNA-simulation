...
#arguments="-geant -reac glaub -e asymbw 1.210 0.09 2 0 -n 1000000 -strag 1 -be 75.75 -nn 1 -np 1"
#arguments="-geant -reac glaub -e asymbw 3.30 0.05 2 0 -n 1000000 -strag 1 -be 75.75 -nn 1 -np 1"
#arguments="-geant -reac glaub -e asymbw 1.90 0.03 2 0 -n 1000000 -strag 1 -be 75.75 -nn 1 -np 1"
arguments="-geant -reac glaub -e therm 0.2 -n 1000000 -strag 1 -be 75.75 -nn 1 -np 1"
...
MoNADetFile="detector_config_LISA24O"
