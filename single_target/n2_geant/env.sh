...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 != X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 ] ; then
    G4INSTALL="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/src/geant4"
else
    G4INSTALL="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xy != Xn ] ; then 
    if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 != X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 ] ; then
        G4INCLUDE="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/include/geant4"
    else
        G4INCLUDE="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/include/"
    fi
    export G4INCLUDE
    if [ X$g4non_display = X ] ; then
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/lib != X ] ; then 
    if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 != X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01 ] ; then
        G4LIB="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/lib/geant4"
    else
        G4LIB="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/lib"
    fi
    export G4LIB
    if [ X$g4non_display = X ] ; then
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/PhotonEvaporation2.0 != X ] ; then 
    G4LEVELGAMMADATA="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/PhotonEvaporation2.0"
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RadioactiveDecay3.2 != X ] ; then 
    G4RADIOACTIVEDATA="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RadioactiveDecay3.2"
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4EMLOW6.9 != X ] ; then 
    G4LEDATA="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4EMLOW6.9"
    export G4LEDATA
    if [ X$g4non_display = X ] ; then
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4NDL3.13 != X ] ; then 
    G4NEUTRONHPDATA="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4NDL3.13"
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4ABLA3.0 != X ] ; then 
    G4ABLADATA="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/G4ABLA3.0"
    export G4ABLADATA
    if [ X$g4non_display = X ] ; then
...
if [ X/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RealSurface1.0 != X ] ; then 
    G4REALSURFACEDATA="/soft/x86_64/lucid/GEANT4/geant4.9.3.p01/data/RealSurface1.0"
...
if [ X/soft/x86_64/lucid/CLHEP/2.0.4.6 != X ] ; then 
    CLHEP_BASE_DIR="/soft/x86_64/lucid/CLHEP/2.0.4.6"
...
if [ X/soft/x86_64/lucid/CLHEP/2.0.4.6/include != X ] ; then 
    CLHEP_INCLUDE_DIR="/soft/x86_64/lucid/CLHEP/2.0.4.6/include"
...
if [ X/soft/x86_64/lucid/CLHEP/2.0.4.6/lib != X ] ; then 
    CLHEP_LIB_DIR="/soft/x86_64/lucid/CLHEP/2.0.4.6/lib"
...
if [ "Xn" = "Xy" -o "Xn" = "Xy" ] ; then
    QTFLAGS="-I/usr/include/qt3"
    QTLIBS="-L/usr/lib -lqt-mt"
    QTMOC="/usr/bin/moc-qt3"
    export QTFLAGS
    export QTLIBS
    export QTMOC
