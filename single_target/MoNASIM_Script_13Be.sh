...
#arguments="-geant -reac glaub -e uniform 0.01 3 -n 100000 -strag 1 -be 54.90 -nn 2 -np 2"
arguments="-geant -reac glaub -e asymbw 0.40 0.800 2 0 -n 100000 -strag 1 -be 54.90 -nn 2 -np 2" #"ground" state #-n number of events
#arguments="-geant -reac glaub -e asymbw 1.0 0.300 2 0 -n 1000000 -strag 1 -be 54.90 -nn 2 -np 2" #"ground" state #-n number of events
#arguments="-geant -reac glaub -e asymbw 2.20 1.500 2 0 -n 1000000 -strag 1 -be 54.90 -nn 2 -np 2" #"ground" state #-n number of events

#arguments="-exp 12004_dp -geant -reac glaub -e bw 0.5 0.001 -n 100000 -strag 1 -be 55.0 -nn 2 -np 2" #"ground" state #-n number of events
...
UniqueID="_051016_Drift"
#UniqueID="_EUniform_NarrowCRDC1_100k_glaub0x5"
