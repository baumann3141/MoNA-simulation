...
#arguments="-exp 12004_dp -geant -reac glaub -e asymbw 0.77 0.172 2 0 -n 200 -strag 1 -be 80.0 -nn 3 -np 2" #"ground" state #-n number of events
...
arguments="-exp 12004_dp -geant -reac glaub -e asymbw 0.750 0.001 2 0 -n 100000 -strag 1 -be 80.0 -nn 0 -np 1" #"ground" state #-n number of events
