...
#arguments="-exp 05039_O25 -geant -reac glaub  -e asymbw 0.77 0.172 2 0  -n 150000 -strag 1 -glaub 1 " #-n number of events

#arguments="-exp 05039_O25 -geant -reac glaub  -e asymbw 0.77 0.172 2 0  -n 100000 -strag 1 -glaub 1" #-n number of events
arguments="-exp 05039_O25 -geant -reac glaub  -e const 0.001  -n 20000 -strag 0 -glaub 0" #-n number of events
...
analysispath="/projects/mona-sim/kuchera/jonesm"
stmonapath="/projects/mona-sim/kuchera/jonesm/st_mona"
n2geantpath="/projects/mona-sim/kuchera/jonesm/n2_geant"
#DataPath="/evtdata/08016a/simdata/kohley_simdata/O25Calem"
#DataPath="/projects/08026/zach_hope_analysis/monasim_files/"
DataPath="/mnt/simulations/MoNA_EfficiencyTest"
