...
analysispath="/projects/mona-sim/baumann/single-target"
stmonapath="/projects/mona-sim/baumann/single-target/st_mona"
n2geantpath="/projects/mona-sim/baumann/single-target/n2_geant"
