...
#phase space decay
#arguments="-exp 12004_dp -geant -reac 4body_decay -e asymbw 1.590 0.500 2 0 -n 100000 -strag 1 -be 80.0 -nn 1 -np 2" #"ground" state #-n number of events

#sequential through 26O
arguments="-exp 12004_dp -geant -reac 4body_decay -e1 asymbw 4.000 0.500 2 0 -e2 4body_Constrained 0.15 0.005 2 0 -n 200 -strag 1 -be 80.0 -nn 1 -np 2" #"ground" state #-n number of events
