...
FileName="7Li-unreacted"
#InputFile="input.txt"

arguments="-reac glaub_noDecay -n 280000 -glaub 1 -strag 0 -be 79.85"
...
DataPath="/mnt/simulations/MoNAsims/DV_dump"

#used to allow multiple geant runs simultaneously 
#UniqueID="_E400_W800_mil"
#UniqueID="_InitialSettings"
#UniqueID="_bSpotDy_0x4"
